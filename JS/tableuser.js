...
function show_select_pb() {
  ...
  function open_phongbanmoi(id_phongban, ten_phongban){
    ...
    document.getElementById("kg_mau").innerHTML =  `<div id="${id_phongban}">
                                                      <phongban-label style="background-color: rgb(224, 117, 45);" id="lable_mau">${ten_phongban}</phongban-label>
                                                        ...
                                                        <div class="overlay-content">
                                                          ...
                                                          <div class="content-sidebar" id="content${id_phongban}">
                                                              <h2>Tôi là Karo</h2>
                                                              <p>Đây là phần nội dung của danh mục ${ten_phongban}</p>
                                                              <p>Danh mục này đang trong quá trình chỉnh sửa - Danh mục này đang trong quá trình chỉnh sửa - Danh mục này đang trong quá trình chỉnh sửa</p>
                                                              <p>Danh mục này đang trong quá trình chỉnh sửa - Danh mục này đang trong quá trình chỉnh sửa - Danh mục này đang trong quá trình chỉnh sửa</p>
                                                          </div>
                                                        </div>
                                                      </div>`
